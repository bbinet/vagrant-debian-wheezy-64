...
apt-get update
DEBIAN_FRONTEND=noninteractive apt-get install -yq --no-install-recommends -t wheezy-backports linux-image-3.14-0.bpo.2-amd64 linux-headers-3.14-0.bpo.2-amd64
# BBI ####################
